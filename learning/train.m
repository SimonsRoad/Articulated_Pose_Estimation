...
for i = 1:numpos
	...
	%feat = hog(im, model.sbin,model.sbin,2,2,9,0.5,'localinterpolate', 'unsigned', 'l2hys');
	%feat = myHog(vl_hog(single(im), model.sbin, 'verbose', 'variant','dalaltriggs'));
    feat = myHog(im, model.sbin);
